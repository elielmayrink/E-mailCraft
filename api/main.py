...
# Configurar PYTHONPATH para importações funcionarem corretamente na estrutura da Vercel
...
# Carregar variáveis de ambiente do arquivo config.env no backend
load_dotenv(backend_root / 'config.env')

# Na estrutura da Vercel, sempre usar root_path="/api"
